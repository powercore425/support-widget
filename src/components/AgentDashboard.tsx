  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="flex h-screen relative">
        ...
        <div className={`absolute sm:relative w-80 bg-white border-r border-gray-200 flex flex-col z-50 h-full transition-transform duration-300 ${
          isSidebarOpen ? 'translate-x-0' : '-translate-x-full sm:translate-x-0'
        }`}>
          <div className="p-3 sm:p-4 border-b border-gray-200 bg-blue-600 text-white">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => setIsSidebarOpen(false)}
                  className="sm:hidden text-white hover:bg-blue-700 rounded p-1"
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="text-sm bg-blue-700 border border-blue-500 rounded px-2 py-1.5 sm:py-1 flex-1"
          ...
          {selectedConversation ? (
                ...
                <div className="flex justify-between items-center gap-2">
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                    <button
                      ...
                      className="sm:hidden text-gray-500 hover:text-gray-700 flex-shrink-0"
                  ...
                  <button
                    ...
                    className="text-gray-500 hover:text-gray-700 active:text-gray-900 flex-shrink-0 touch-manipulation"
            ...
            <div className="flex-1 flex items-center justify-center bg-gray-50 p-4">
              <div className="text-center text-gray-500">
                <button
                  onClick={() => setIsSidebarOpen(true)}
                  className="sm:hidden mb-4 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors"
                >
                  Open Conversations
                </button>
